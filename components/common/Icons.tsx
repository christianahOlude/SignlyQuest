...
// HandWaveIcon
export const HandWaveIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 12c0 2.42-.943 4.633-2.483 6.257l-2.672-2.672m-4.94-4.94l-2.672-2.672A7.5 7.5 0 017.864 4.243z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.875 14.125l2.672 2.672-2.483 2.483c-1.624-1.624-2.483-3.837-2.483-6.257 0-1.28.246-2.5.688-3.625l-2.672 2.672" />
    </svg>
);
