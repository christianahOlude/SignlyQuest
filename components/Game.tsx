...
//
//     if (showChallenge) {
//         return <ChallengeMode onExit={() => setShowChallenge(false)} />;
//     }
//
//
//     useEffect(() => {
...
//               className="w-full mt-4 flex items-center justify-center gap-3 bg-indigo-500 text-white font-bold text-lg py-4 rounded-lg hover:bg-indigo-600 transition-all duration-300"
//           >
//               🏆 Daily Challenge
//           </button>
//
...
import ScoreScreen from './ScoreScreen';
import { PlayIcon } from './common/Icons';
import ChallengeMode from "./ChallengeMode.tsx";
